...
#if !defined(CONFIG_BOARD_THUNDERBIRD_EDN31) && !defined(CONFIG_BOARD_THUNDERBIRD_EDN5x) && !defined(CONFIG_BOARD_TOTORO) && !defined(CONFIG_BOARD_LUISA) && !defined(CONFIG_BOARD_LUISA_DS) && !defined(CONFIG_BOARD_TASSVE) && !defined(CONFIG_BOARD_COOPERVE) && !defined(CONFIG_BOARD_TORINO) && !defined(CONFIG_BOARD_AMAZING)  && !defined(CONFIG_BOARD_CORI_DS)
